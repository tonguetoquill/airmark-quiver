...
// the first level (0.5in, then +0.25in per level) to match Figure 1's own
// spacing — a flat 0.5in-per-level step over-indents nested items.
#let INDENT_TABLE = (0pt, 0.5in, 0.75in, 1in)
