// render_fixture.mjs — render an appointment-letter fixture markdown file to PDF using the
// real quillmark engine (@quillmark/wasm + @quillmark/quiver), the same
// pipeline `npx quillkit test` uses.
//
// Usage: node design/usaf_appointment/render_fixture.mjs <fixture.md> <output.pdf>
//
...
if (!fixturePath || !outputPath) {
  console.error("Usage: node design/usaf_appointment/render_fixture.mjs <fixture.md> <output.pdf>");
  process.exit(1);
}
